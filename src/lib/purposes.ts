...
export const PURPOSES: Purpose[] = [
  ...
  },
  {
    ...
    label: "Explainer",
    glyph: "💡",
    tagline: "Product & feature videos that teach",
    modality: "video",
    aspectRatio: "16:9",
    durationSec: 5,
    modelId: "seedance-2-pro",
    classes: ["product", "scene", "character"],
    placeholder: "What are you explaining — the product, the feature, the moment it clicks?",
    ideas: [
      "A laptop on a tidy desk glows as an animated checklist ticks itself complete, modern tech aesthetic",
      "The earbuds pair to a phone on a clean desk, a soft pulse of light traveling between them",
    ],
    styleSuffix: "clean explainer video, bright modern setting, clear uncluttered framing, professional product-marketing look",
  },
  {
    id: "training",
    label: "Training",
    glyph: "🎓",
    tagline: "Scenario & safety videos, no film crew",
    modality: "video",
    aspectRatio: "16:9",
    durationSec: 10,
    modelId: "seedance-2-pro",
    classes: ["character", "scene"],
    placeholder: "Describe the workplace scenario — who, where, and what they demonstrate…",
    ideas: [
      "A warehouse worker in a hi-vis vest demonstrates correct lifting posture beside tall shelving, clear instructional framing",
      "A barista walks through the closing checklist behind the counter, wiping the machine, clear steps",
    ],
    styleSuffix: "instructional training video, clear staging, bright even lighting, realistic workplace detail",
  },
  {
    id: "course",
    label: "Course",
    glyph: "📚",
    tagline: "Lesson visuals & course intros",
    modality: "video",
    aspectRatio: "16:9",
    durationSec: 10,
    modelId: "seedance-2-pro",
    classes: ["scene", "character", "audio"],
    placeholder: "What's the lesson — the concept, the moment, the visual that makes it click?",
    ideas: [
      "The solar system forms from a swirling disk of dust and gas, planets condensing one by one, clear scientific visualization",
      "A medieval market street comes to life around the camera, documentary style, for a history lesson intro",
    ],
    styleSuffix: "educational visualization, clear composition, engaging motion, documentary lighting",
  },
  {
    id: "internal",
    label: "Internal Comms",
    glyph: "📣",
    tagline: "Announcements your team will watch",
    modality: "video",
    aspectRatio: "16:9",
    durationSec: 5,
    modelId: "seedance-2-lite",
    classes: ["character", "scene", "audio"],
    placeholder: "What's the announcement — the launch, the milestone, the change?",
    ideas: [
      "Confetti drifts over a modern open-plan office as a small team celebrates at a standing desk, warm light",
      "A rocket made of sticky notes lifts off a whiteboard, playful office energy, milestone announcement",
    ],
    styleSuffix: "upbeat corporate announcement video, modern office setting, warm natural light, energetic pacing",
  },
  {
    id: "fashion",
    label: "Fashion",
