    ...
    >
      <Section heading="1. Data we collect">
        ...
        <ul className="ml-5 list-disc space-y-1.5">
          ...
          <li>
            ...
            payment-card details are collected and processed by our payment processor, Stripe, and are
      ...
      <Section heading="2. How we use your data">
        <ul className="ml-5 list-disc space-y-1.5">
          ...
          <li>To process payments and provide invoices (through Stripe, our payment processor).</li>
      ...
      <Section heading="4. Payments">
        <p>
          ...
          you provide your payment details directly to Stripe under Stripe&rsquo;s own privacy policy. We
      ...
      <Section heading="6. Sharing your data">
        <p>
          ...
          Stripe for payment processing; and authorities or advisers where required by law or to protect
